...
export default function LiveTeachingPage() {
  ...
  const features = [
    { icon: Video, text: 'تفاعل مباشر مع المعلمين', color: 'from-[#0A5734] to-[#4A8F5C]' },
    { icon: Users, text: 'مجموعات صغيرة لتعلم أفضل', color: 'from-[#4A8F5C] to-[#0A5734]' },
    { icon: MessageCircle, text: 'أسئلة وإجابات فورية', color: 'from-[#0A5734] to-[#4A8F5C]' },
    { icon: Clock, text: 'جلسات منتظمة ومنظمة', color: 'from-[#4A8F5C] to-[#0A5734]' },
  ];
            ...
            >
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <Card className="h-full border-2 border-[#0A5734]/20 dark:border-[#4A8F5C]/30 hover:border-[#0A5734] dark:hover:border-[#4A8F5C] bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm hover:shadow-lg transition-all duration-300 flex flex-col">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredCourses.map((course, index) => (
                  <motion.div
                    ...
                    className="h-full"
                  >
                    <Card className="h-full border-2 border-slate-200 dark:border-slate-700 hover:border-[#0A5734] dark:hover:border-[#4A8F5C] bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group cursor-pointer"
                    ...
                    >
                      ...
                      <CardContent className="p-6">
                        ...
                        {/* Teacher Info */}
                        <div className="flex items-center gap-3 mb-6 p-3 rounded-lg bg-[#0A5734]/5 dark:bg-[#0A5734]/10 border border-[#0A5734]/20 dark:border-[#4A8F5C]/30">
                          {(() => {
                        ...
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-[#0A5734] to-[#4A8F5C] hover:from-[#073D24] hover:to-[#3A7148] text-white font-bold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 group/btn"
                        >
        ...
        {showModal && selectedCourse && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border-2 border-[#0A5734]/20 dark:border-[#4A8F5C]/30"
            >
              {/* Modal Header */}
              <div className="sticky top-0 bg-gradient-to-r from-[#0A5734] via-[#4A8F5C] to-[#0A5734] p-6 text-white flex items-center justify-between z-10">
              ...
              <div className="p-8">
                <div className="mb-8">
                  <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-[#0A5734] to-[#4A8F5C] dark:from-[#4A8F5C] dark:to-[#5BA86D] bg-clip-text text-transparent">
                  ...
                  <motion.div
                    ...
                    className={`cursor-pointer rounded-2xl p-6 border-2 transition-all duration-300 ${
                      selectedType === 'individual'
                        ? 'border-[#0A5734] bg-[#0A5734]/5 dark:bg-[#0A5734]/20 shadow-xl ring-2 ring-[#0A5734]/20 dark:ring-[#4A8F5C]/30'
                        : 'border-slate-200 dark:border-slate-700 hover:border-[#0A5734] dark:hover:border-[#4A8F5C]'
                    }`}
                  >
                    <div className="flex items-center gap-4 mb-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        selectedType === 'individual'
                          ? 'bg-gradient-to-br from-[#0A5734] to-[#4A8F5C]'
                      ...
                      {[
                        ...
                        <li key={idx} className="flex items-start gap-2">
                          <Check className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                            selectedType === 'individual' ? 'text-[#0A5734] dark:text-[#4A8F5C]' : 'text-slate-400'
                          }`} />
                    ...
                    {selectedType === 'individual' && (
                      <div className="flex items-center gap-2 text-[#0A5734] dark:text-[#4A8F5C] font-bold">
                  ...
                  >
                    ...
                    <ul className="space-y-2 mb-4">
                      {[
                        ...
                        <li key={idx} className="flex items-start gap-2">
                          <Check className={`w-5 h-5 flex-shrink-0 mt-0.5 ${
                            selectedType === 'group' ? 'text-[#0A5734] dark:text-[#4A8F5C]' : 'text-slate-400'
                          }`} />
                          <span className="text-sm text-slate-700 dark:text-slate-300">{item}</span>
                        </li>
                      ))}
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    onClick={handleCloseModal}
                    className="flex-1 px-6 py-4 bg-white dark:bg-slate-700 text-[#0A5734] dark:text-[#4A8F5C] border-2 border-[#0A5734] dark:border-[#4A8F5C] rounded-xl font-bold hover:bg-[#0A5734]/5 dark:hover:bg-[#4A8F5C]/20 transition-all duration-300"
                  >
                    إلغاء
                  </button>
                  <button
                    ...
                    className={`flex-1 px-6 py-4 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 ${
                      !selectedType || submitting
                        ...
                        : 'bg-gradient-to-r from-[#0A5734] to-[#4A8F5C] hover:from-[#073D24] hover:to-[#3A7148] text-white shadow-lg hover:shadow-xl'
                    }`}
                  >
                    {submitting ? (
                      <>
