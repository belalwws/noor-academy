...
import { useIsQuranPlaying, useCurrentAyah } from "@/lib/store/hooks/useQuran";
...
export default function AudioPlayer({
  ...
  const [isPlaying, setIsPlaying] = useIsQuranPlaying();
  const [currentAyah, setCurrentAyah] = useCurrentAyah();
