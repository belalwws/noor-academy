  ...
  return (
    <div className="space-y-6">
          ...
          {filteredPayments.length === 0 ? (
            ...
            >
              <Card className="p-12 text-center">
                ...
                <p className="text-gray-500 text-lg">لا توجد دفعات</p>
              </Card>
            </motion.div>
          ) : (
            filteredPayments.map((payment, index) => (
              ...
              >
                <Card className="p-6 hover:shadow-lg transition-shadow border-2 border-gray-100 hover:border-orange-200">
      ...
      <Dialog open={showReviewModal} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-4xl max-h-[95vh] overflow-y-auto bg-white !bg-white backdrop-blur-none">
          <DialogHeader className="pb-4 border-b border-gray-200 !bg-white bg-white">
          ...
          {selectedPayment && (
            <div className="space-y-6 py-4 !bg-white bg-white">
              {/* Student Info */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <span className="text-sm text-gray-600 block">الاسم الكامل:</span>
                      <p className="font-semibold text-base text-gray-900">{selectedPayment.student_name}</p>
                    </div>
                    <div className="space-y-1">
                      <span className="text-sm text-gray-600 block">البريد الإلكتروني:</span>
                      <p className="font-semibold text-base text-gray-900 break-all">{selectedPayment.student_email}</p>
                    </div>
                  </div>
                </div>
              </Card>
