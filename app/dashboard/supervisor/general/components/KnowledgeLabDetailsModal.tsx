            ...
            <>
              ...
              {labDetails.status === 'approved' && labDetails.approved_at && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.6, duration: 0.4 }}
                  className="bg-blue-50/80 dark:bg-blue-900/20 border-2 border-blue-200/50 dark:border-blue-700/30 rounded-2xl p-5 shadow-md"
                >
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="font-bold text-blue-800 dark:text-blue-300 mb-2">معلومات الموافقة</h4>
              ...
              <div className="flex gap-3">
                ...
                {onApprove && (
                  <Button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white border-0 shadow-xl hover:shadow-2xl font-bold px-8 py-3 text-base"
                  >
