      ...
      <DialogContent className="sm:max-w-[500px] bg-white dark:bg-slate-900" dir="rtl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button type="submit" disabled={updating} className="bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 hover:from-amber-600 hover:via-amber-700 hover:to-orange-700 text-white shadow-lg">
              {updating ? (
                <>
