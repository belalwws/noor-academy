      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-20 md:pt-24 lg:pt-28" dir="rtl">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
          ...
          {loading ? (
            ...
            >
              <Card className="p-12 text-center bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-2 border-dashed border-orange-200 dark:border-orange-800 shadow-lg">
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{ type: "spring", stiffness: 260, damping: 20 }}
                  className="mx-auto w-20 h-20 bg-gradient-to-br from-orange-100 to-amber-100 dark:from-orange-900/30 dark:to-amber-900/30 rounded-2xl flex items-center justify-center mb-6"
                >
                ...
                <p className="text-slate-600 dark:text-slate-400 mb-6 text-base">
                  {searchQuery 
                    ...
                    : 'ابدأ بإنشاء مجموعة جماعية جديدة للدورة'
                  }
                </p>
                {!searchQuery && (
                  <motion.div
                  ...
                  >
                    <Button
                      ...
                      className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white shadow-lg hover:shadow-xl px-8 py-6 text-lg"
                    >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {filteredBatches.map((batch, idx) => (
                <motion.div
                  ...
                  className="h-full"
                >
                  <Card className="h-full hover:shadow-2xl transition-all duration-300 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-2 border-orange-200/50 dark:border-orange-800/50 hover:border-orange-400 dark:hover:border-orange-600 flex flex-col group">
                    <CardHeader className="pb-4 relative overflow-hidden flex-shrink-0">
                      <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-100/50 to-amber-100/30 dark:from-orange-900/20 dark:to-amber-800/10 rounded-full blur-2xl" />
                    ...
                    <CardContent className="relative z-10 flex-1 flex flex-col pt-0">
                      ...
                      <div className="flex gap-2 mt-auto">
                        <Button 
                          variant="default" 
                          size="sm" 
                          className="flex-1 gap-2 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white shadow-lg hover:shadow-xl transition-all duration-300"
            ...
            <DialogContent className="sm:max-w-[500px] bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm border border-slate-200 dark:border-slate-700 shadow-2xl">
              ...
              <DialogFooter className="pt-4 border-t border-slate-200 dark:border-slate-700">
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white shadow-lg hover:shadow-xl"
                >
                  <Plus className="w-4 h-4 mr-2" />
                  إنشاء
                </Button>
