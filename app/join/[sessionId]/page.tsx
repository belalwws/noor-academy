      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-teal-50 to-cyan-50 flex items-center justify-center" dir="rtl">
        <div className="text-center bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl max-w-md">
          <div className="relative mb-8">
            ...
            <Sparkles className="w-8 h-8 text-blue-500 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 via-teal-600 to-cyan-600 text-white py-12 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-blue-100 text-lg">تحقق من الإعدادات وانضم للجلسة التعليمية</p>
            <div className="flex items-center justify-center gap-2 mt-4">
              <Sparkles className="w-5 h-5 text-yellow-300" />
              <span className="text-blue-200">تجربة تعليمية تفاعلية</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-sm overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-teal-50 pb-6">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-2xl text-blue-800 mb-2">{sessionInfo.title}</CardTitle>
                      <div className="flex items-center gap-2">
                        <Badge className="bg-gradient-to-r from-blue-500 to-teal-600 text-white px-3 py-1">
                          <GraduationCap className="w-4 h-4 ml-1" />
                          جلسة مباشرة
                        </Badge>
                        {sessionInfo.is_live && (
                          <Badge className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1 animate-pulse">
                ...
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-2xl p-6 text-center">
                      <div className="w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <Clock className="w-6 h-6 text-white" />
                      </div>
                      <div className="text-2xl font-bold text-blue-800 mb-1">{sessionInfo.duration_minutes}</div>
                      <div className="text-sm text-blue-600">دقيقة</div>
                    </div>
                  ...
                  {!sessionInfo.is_live ? (
                    ...
                    <div className="text-center">
                      ...
                      <Button
                        ...
                        disabled={joining}
                        className="w-full bg-gradient-to-r from-blue-600 via-teal-600 to-cyan-600 hover:from-blue-700 hover:via-teal-700 hover:to-cyan-700 text-white font-bold py-6 px-8 rounded-2xl text-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-xl"
                        size="lg"
                      >
                        {joining ? (
                          <>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-4">
                        <div className="flex items-center justify-between text-sm mb-2">
                          <span className="font-medium text-blue-800">الوقت المتبقي</span>
                          <span className="font-bold text-blue-700">{sessionInfo.remaining_time}</span>
                        </div>
              ...
              <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  {[
                    ...
                    <div key={index} className="flex items-start gap-3 p-3 rounded-xl bg-gradient-to-r from-blue-50 to-blue-50 border border-blue-100">
