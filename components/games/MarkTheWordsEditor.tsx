              ...
              return (
                <motion.button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg border-2 transition-all cursor-pointer ${
                    isSelected
                      ? 'bg-green-100 dark:bg-green-900/50 border-green-400 dark:border-green-600 text-green-900 dark:text-green-100'
                ...
                >
                  ...
                  {isSelected ? (
                    <span className="text-green-600 dark:text-green-400">✓ صحيح</span>
                  ) : (
