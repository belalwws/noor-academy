...
export const WomenAdultsSection: React.FC = () => {
  ...
  return (
    <section id="women-adults" className="relative py-12 md:py-16 lg:py-20 bg-white dark:bg-slate-950 overflow-hidden" dir="rtl">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="absolute w-full h-full max-w-lg bg-gradient-to-br from-[#4A8F5C]/18 to-[#0A5734]/12 rounded-full blur-3xl animate-pulse" />
                <div className="absolute w-[90%] h-[90%] bg-gradient-to-br from-[#C5A15A]/10 to-[#0A5734]/8 rounded-full blur-2xl animate-pulse delay-1000" />
              </div>
