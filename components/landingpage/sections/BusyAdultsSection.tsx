          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="absolute w-full h-full max-w-lg bg-gradient-to-br from-[#C5A15A]/18 to-[#4A8F5C]/12 rounded-full blur-3xl animate-pulse" />
                <div className="absolute w-[90%] h-[90%] bg-gradient-to-br from-[#0A5734]/10 to-[#4A8F5C]/8 rounded-full blur-2xl animate-pulse delay-1000" />
              </div>
