      ...
      <div className="container mx-auto px-4 lg:px-8 py-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-text-primary dark:text-slate-50 mb-6 leading-tight">
            <span className="text-[#1e40af] dark:text-blue-400 font-extrabold">من نحن</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <h4 className="text-4xl md:text-5xl font-bold text-[#1e40af] dark:text-blue-400 mb-2">
                  {stat.number}
                </h4>
