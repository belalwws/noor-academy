...
export const KidsLearningSection: React.FC = () => {
  ...
  return (
    <section id="kids-learning" className="relative py-8 md:py-12 lg:py-14 bg-gradient-to-b from-white via-[#0A5734]/4 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden" dir="rtl">
