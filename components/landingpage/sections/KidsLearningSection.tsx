...
export const KidsLearningSection: React.FC = () => {
  ...
  return (
    <section id="kids-learning" className="relative py-12 md:py-16 lg:py-20 bg-gradient-to-b from-white via-[#0A5734]/4 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden" dir="rtl">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-bold text-[#0A5734] dark:text-[#4A8F5C] tracking-wide">تعليم الأطفال</span>
            </motion.div>

            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-[1.2] tracking-tight">
              <span className="text-[#222222] dark:text-slate-50 block mb-4">هل ترغبين أن يُقبل طفلك</span>
