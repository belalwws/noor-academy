...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-[65vh] flex items-center pt-16 pb-12 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-300" dir="rtl">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-[#0A5734]/6 via-[#4A8F5C]/4 to-transparent rounded-full blur-[120px] -translate-y-1/3 translate-x-1/3" />
      <div className="absolute bottom-0 left-0 w-[700px] h-[700px] bg-gradient-to-tr from-[#C5A15A]/5 via-[#4A8F5C]/3 to-transparent rounded-full blur-[120px] translate-y-1/3 -translate-x-1/3" />
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-bold text-[#0A5734] dark:text-[#4A8F5C] tracking-wide">منصة تعليمية عريقة</span>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl lg:text-2xl text-[#555555] dark:text-slate-300 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light"
            >
            ...
            <motion.div
              ...
              className="flex items-center justify-center lg:justify-start gap-4 lg:gap-6 pt-4 border-t-2 border-[#0A5734]/10 dark:border-[#4A8F5C]/20"
            >
              {stats.map((stat, index) => {
                ...
                return (
                  <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1, y: 0 }}
                    transition={{ delay: 0.65 + index * 0.12, type: "spring", stiffness: 200 }}
                    className="group relative"
                  >
                    <div className="relative bg-gradient-to-br from-white to-[#0A5734]/5 dark:from-slate-900 dark:to-slate-800 rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#0A5734]/10 dark:border-[#4A8F5C]/20 min-w-[100px]">
            ...
            >
              <Button 
                ...
                className="group relative bg-gradient-to-r from-[#0A5734] via-[#4A8F5C] to-[#0A5734] hover:from-[#073D24] hover:via-[#3A7148] hover:to-[#073D24] text-white px-10 py-6 text-base lg:text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden"
                size="lg"
              >
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="absolute w-full h-full max-w-lg bg-gradient-to-br from-[#0A5734]/15 to-[#4A8F5C]/10 rounded-full blur-3xl animate-pulse" />
              <div className="absolute w-[90%] h-[90%] bg-gradient-to-br from-[#C5A15A]/8 to-[#4A8F5C]/6 rounded-full blur-2xl animate-pulse delay-1000" />
            </div>
