          ...
          >
            <div className="relative w-full h-[900px] flex items-center justify-center">
              ...
              <motion.div
                ...
                className="absolute top-48 left-16 bg-gradient-to-br from-[#0A5734] to-[#4A8F5C] text-white p-5 rounded-2xl shadow-glow z-10"
              >
                <PlayCircle size={36} />
              </motion.div>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#0A5734]/10 dark:bg-[#0A5734]/20 rounded-xl flex items-center justify-center">
                    <Clock className="text-[#0A5734] dark:text-[#4A8F5C]" size={24} />
                  </div>
                  <div>
