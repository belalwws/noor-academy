...
import { PlayCircle, Clock, Rewind, BookOpen, CheckCircle, ArrowLeft, Sparkles } from 'lucide-react';
import Link from 'next/link';
import Lottie from 'lottie-react';

export const RecordedCoursesSection: React.FC = () => {
  ...
  const features = [
    {
      icon: Clock,
      text: 'تعلم في الوقت المناسب لك',
    },
    {
      icon: Rewind,
      text: 'إعادة المشاهدة متى شئت',
    },
    {
      icon: BookOpen,
      text: 'محتوى منظم ومتاح دائماً',
    },
    {
      icon: PlayCircle,
      text: 'جودة عالية في التسجيل',
    },
  ];
  ...
  return (
    <section 
      id="recorded-courses" 
      dir="rtl"
      className="relative py-0 bg-background-light dark:bg-slate-950 transition-colors duration-300 overflow-hidden"
    >
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-text-primary dark:text-slate-50">في الوقت الذي يناسبك</span>
            </motion.h2>
            ...
            >
              استمتع بتجربة تعليمية مرنة مع دوراتنا المسجلة عالية الجودة. تعلم في الوقت والمكان 
              الذي يناسبك، وأعد مشاهدة الدروس متى احتجت. محتوى تعليمي منظم ومتاح دائماً، 
              مصمم ليتناسب مع جدولك المزدحم ويساعدك على التعلم بالسرعة التي تناسبك.
            </motion.p>
          ...
          >
            <div className="relative w-full h-[900px] flex items-center justify-center">
              ...
              <motion.div
                ...
                className="absolute top-48 left-16 bg-gradient-to-br from-[#1e40af] to-[#2563eb] text-white p-5 rounded-2xl shadow-glow z-10"
              >
                <PlayCircle size={36} />
              </motion.div>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#1e40af]/10 dark:bg-blue-500/20 rounded-xl flex items-center justify-center">
                    <Clock className="text-[#1e40af] dark:text-blue-400" size={24} />
                  </div>
                  <div>
                    <h4 className="font-bold text-text-primary dark:text-slate-100">تعلم مرن</h4>
                    <p className="text-sm text-text-secondary dark:text-slate-400">في الوقت المناسب</p>
                  </div>
                </div>
              </motion.div>
